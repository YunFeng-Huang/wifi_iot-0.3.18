...
public class WifiIotPlugin
  ...
  private boolean selectNetwork(final Network network, final ConnectivityManager manager) {
    Log.e(WifiIotPlugin.class.getSimpleName(), "Build.VERSION.SDK_INT >= Build.VERSION_CODES.M"+(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M));
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
  ...
  private void forceWifiUsage(final MethodCall poCall, final Result poResult) {
    ...
    if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP && manager != null) {
      if (useWifi) {
        Log.e(
                WifiIotPlugin.class.getSimpleName(), "joinedNetwork");
        ...
        if (joinedNetwork != null) {
          ...
          Log.e(WifiIotPlugin.class.getSimpleName(), "joinedNetwork111111");
  ...
  private void connectTo(
    ...
    final Handler handler = new Handler(Looper.getMainLooper());
    Log.e(WifiIotPlugin.class.getSimpleName(), "Build.VERSION.SDK_INT < Build.VERSION_CODES.Q: " + (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q));
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
      ...
      Log.e(WifiIotPlugin.class.getSimpleName(), "security != null && security.toUpperCase().equals(\"WEP\"): " + (security != null && security.toUpperCase().equals("WEP")));
      ...
      Log.e(WifiIotPlugin.class.getSimpleName(), "withInternet != null && withInternet: " + (withInternet != null && withInternet));
      ...
      if (withInternet != null && withInternet) {
        ...
        // set security
        if (security != null && security.toUpperCase().equals("WPA")) {
          Log.e(WifiIotPlugin.class.getSimpleName(), "1232131: ");
          builder.setWpa2Passphrase(password);
        }
        ...
        final ConnectivityManager connectivityManager =
            (ConnectivityManager) moContext.getSystemService(Context.CONNECTIVITY_SERVICE);
        Log.e(WifiIotPlugin.class.getSimpleName(), "networkCallback "+networkCallback);
        ...
        networkCallback =
            new ConnectivityManager.NetworkCallback() {
              ...
              public void onAvailable(@NonNull Network network) {
                super.onAvailable(network);
                Log.e(WifiIotPlugin.class.getSimpleName(), "onAvailable ");
                if (!resultSent) {
              ...
              public void onUnavailable() {
                super.onUnavailable();
                Log.e(WifiIotPlugin.class.getSimpleName(), "onUnavailable ");
                if (!resultSent) {
                  poResult.success(false);
                  resultSent = true;
                }
